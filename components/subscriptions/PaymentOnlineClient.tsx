...
export default function PaymentOnlineClient({ initialEntitlement, history, pricing }: { initialEntitlement: Entitlement; history: SubscriptionHistory[]; pricing: Pricing }) {
