...
import { CheckCircle2, Clipboard, Clock3, CreditCard, LoaderCircle, MessageCircle, QrCode, Send } from "lucide-react";
...
export default function PaymentOnlineClient({ initialEntitlement, pricing, pageTitle }: { initialEntitlement: Entitlement; pricing: Pricing; pageTitle: string }) {
